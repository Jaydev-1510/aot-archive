  ...
  locations: [
    {
      ...
      locationType: "nation",
      description:
        "A large empire located beyond the ocean from Paradis Island.",
    },
    {
      ...
      description:
        "A major city in Marley that contains an internment zone for Eldians.",
    },
    {
      ...
      description:
        "A walled district within the city of Liberio where Eldians are forced to live.",
    },
    {
